...
class Check extends Validate
{
    protected $rule = [
        'id'  =>  'require|integer',
        'money'  =>  'require|between:1,5000000|integer',
        'recharge' =>  'require',
        'bank' =>  'require|max:50',
    ...
    protected $message = [
        ...
        'mobile.min'=>'请输入11位手机号',
        'mobile.max'=>'请输入11位手机号',
        'idcard,require'=>'请输入身份证号码',
        'idcard.min'=>'请输入15位至18位身份证',
        'idcard.max'=>'请输入15位至18位身份证',
